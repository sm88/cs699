...
\begin{figure}[tbp]
\begin{center}
\includegraphics[natwidth=450,natheight=400,scale=.5]{Sources/Images/1.eps}
...
\begin{figure}[tbp]
\begin{center}
\includegraphics[natwidth=450,natheight=400,scale=.5]{Sources/Images/2.eps}
...
\begin{figure*}[tbp]
\begin{center}
\includegraphics[natwidth=500,natheight=250]{Sources/Images/3.eps}
...
\begin{figure}[tbp]
\begin{center}
\includegraphics[natwidth=450,natheight=400,scale=.5]{Sources/Images/4.eps}
